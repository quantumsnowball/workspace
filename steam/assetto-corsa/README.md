...
- Also, the game may prompt to install 3 missing fonts, download `ac-fonts.zip` and unzip to `assettocorsa/content/fonts/system`, then game will launch as usual.
