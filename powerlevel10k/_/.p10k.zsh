...
# this will enable the prompt integration for powerlevel10k (emit the OSC 133 sequence)
# this must be put at the end of .p10k.zsh generated by p10k configure otherwise doesn't work
